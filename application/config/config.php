...
$config['sess_cookie_name'] = 'nep_ci_session';
...
/*
| Task testing workflow notification sender (configure SMTP in email.php)
*/
$config['task_notify_from'] = 'noreply@sanpurple.com';
