<?php 
    ...
    if($this->session->userdata('client_id') == NULL){
        echo "<meta http-equiv='refresh' content='0; URL=".base_url('client-login')."' />";
    }
    
    error_reporting(0);
    
    $empnumber = $this->session->userdata('client_id');
...
<head>
    ...
    <title><?php echo ucfirst($client_name); ?> Portal</title>
        ...
        <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              <li class="nav-item">
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="<?php echo base_url();?>client-dashboard/<?php echo $client_name; ?>" role="button" data-bs-toggle="" aria-expanded="false">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="">
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center">
                  ...
                  <p class="logo-text ms-2 d-none d-sm-block"><?php echo ucfirst($client_name); ?></p>
                </div>
              </div>
            </a>
          </div>
          ...
          <ul class="navbar-nav navbar-nav-icons flex-row">
            <li class="nav-item">
              <!-- <div class="theme-control-toggle fa-icon-wait px-2">
                <input class="form-check-input ms-0 theme-control-toggle-input" type="checkbox" data-theme-control="phoenixTheme" value="light" id="themechontrolToggle" />  
                ...
                <div class="card position-relative border-0">
                  <div class="card-body p-0">
                    <div class="text-center pt-4 pb-3">
                      ...
                      <h6 class="mt-2 text-body-emphasis"><?php echo ucfirst($client_name); ?></h6>
                    </div>
                  ...
                  <div class="card-footer p-0 border-top border-translucent">
                    ...
                    <!--</ul>-->
                    <br>
                    <div class="px-3"><a class="btn btn-phoenix-sechondary d-flex flex-center w-100" href="<?php echo base_url();?>client-logout"> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
                    <br>
                  </div>
                </div>
              </div>
