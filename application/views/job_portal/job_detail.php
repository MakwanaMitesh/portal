...
<div class="mb-5">
    <div class="d-flex justify-content-between">
        <h2 class="text-body-emphasis fw-bolder mb-2"><?php echo $get_lead_row->person_name;?> </h2>
    ...
    </div><span class="badge badge-phoenix badge-phoenix-primary"><?php echo $get_lead_row->lead_status;?><span class="ms-1 uil uil-stopwatch"></span></span> &nbsp; <a class="badge badge-phoenix fs-10 badge-phoenix-warning" href="<?php echo base_url();?>create-lead?lead_id=<?php echo $get_lead_row->lead_id;?>">Edit <span class="ms-1 uil uil-edit-alt"></a>
</div>
